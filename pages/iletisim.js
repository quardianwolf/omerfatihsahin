  ...
  <div className="section iletisimSayfa" >
	...
	<div className="section mcb-section no-margin-v equal-height-wrap bg-cover" style={{backgroundColor:"#1e232b"}}>
				<div className="container">
					<div className="row">
						{iletisimData.map((iletisimm, i)=>{return( 
						<div className="col-md-4" style={{padding:"80px 5% 65px", backgroundColor:"#e0dad2", zIndex: "99"}}>
						...
						<div className="col-md-4" >
							<img src={urlFor(iletisimm.image[0])} style={{position: "absolute", left: "-100px", width: "553px", height: "645px" }} />
